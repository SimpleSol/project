...
public class ViewStateSwitcher {
    ...
    public void switchToMain(boolean animate) {
        switchToState(State.STATE_MAIN, animate);
    }

    public void switchToLoading(boolean animate) {
        switchToState(State.STATE_LOADING, animate);
    }

    public void switchToEmpty(boolean animate) {
        switchToState(State.STATE_EMPTY, animate);
    }

    public void switchToNotFound(boolean animate) {
        switchToState(State.STATE_NOT_FOUND, animate);
    }

    public void switchToError(boolean animate) {
        switchToState(State.STATE_ERROR, animate);
    }
